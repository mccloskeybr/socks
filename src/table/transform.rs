...
pub(crate) fn insert_op(validated_op: InsertProto, schema: &TableSchema) -> (u32, InternalRowProto) {
    let mut key = 0;
...
pub(crate) fn read_row_op(validated_op: ReadRowProto, schema: &TableSchema) -> u32 {
